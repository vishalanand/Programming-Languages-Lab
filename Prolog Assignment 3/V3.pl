...
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ (T3=TL3),count(S,L1,0,Y),\+ (Y>=2),
...
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ (T3=TL3),\+ (Da=O),count(S,L1,0,Y),\+ (Y>=2),
...
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ (T3=TL3),route(X,D,Da,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ (Y>=2),
...
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ (T3=TL3),\+ (Da=O),route(X,D,O,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ (Y>=2),
