...
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ T3=TL3,count(S,L1,0,Y),\+ Y>=3,
							 count(D,L1,0,X),\+ X>=3,addelem([M,Da,TL1,TL2,TL3,S,Da,TA1,TA2,TA3,D],L1,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1>T1,count(S,L1,0,Y),\+ Y>=3,
							 count(D,L1,0,X),\+ X>=3,addelem([M,Da,TL1,TL2,TL3,S,Da,TA1,TA2,TA3,D],L1,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1=T1,TL2>=T2,count(S,L1,0,Y),\+ Y>=3,
							 count(D,L1,0,X),\+ X>=3,addelem([M,Da,TL1,TL2,TL3,S,Da,TA1,TA2,TA3,D],L1,L).
			   
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ T3=TL3,\+ Da=O,count(S,L1,0,Y),\+ Y>=3,
							 count(D,L1,0,X),\+ X>=3,addelem([M,Da,TL1,TL2,TL3,S,O,TA1,TA2,TA3,D],L1,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1>T1,\+ Da=O,count(S,L1,0,Y),\+ Y>=3,
							 count(D,L1,0,X),\+ X>=3,addelem([M,Da,TL1,TL2,TL3,S,O,TA1,TA2,TA3,D],L1,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,D,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1=T1,TL2>=T2,\+ Da=O,count(S,L1,0,Y),\+ Y>=3,
							 count(D,L1,0,X),\+ X>=3,addelem([M,Da,TL1,TL2,TL3,S,O,TA1,TA2,TA3,D],L1,L).
			   
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ T3=TL3,route(X,D,Da,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ Y>=3,
							 count(X,L2,0,Z),\+ Z>=3,addelem([M,Da,TL1,TL2,TL3,S,Da,TA1,TA2,TA3,X],L2,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1>T1,route(X,D,Da,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ Y>=3,
							 count(X,L2,0,Z),\+ Z>=3,addelem([M,Da,TL1,TL2,TL3,S,Da,TA1,TA2,TA3,X],L2,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,Da,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1=T1,TL2>=T2,route(X,D,Da,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ Y>=3,
							 count(X,L2,0,Z),\+ Z>=3,addelem([M,Da,TL1,TL2,TL3,S,Da,TA1,TA2,TA3,X],L2,L).
						
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),\+ T3=TL3,\+ Da=O,route(X,D,O,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ Y>=3,
						     count(X,L2,0,Z),\+ Z>=3,addelem([M,Da,TL1,TL2,TL3,S,O,TA1,TA2,TA3,X],L2,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1>T1,\+ Da=O,route(X,D,O,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ Y>=3,
							 count(X,L2,0,Z),\+ Z>=3,addelem([M,Da,TL1,TL2,TL3,S,O,TA1,TA2,TA3,X],L2,L).
route(S,D,Da,T1,T2,T3,L1,L):-journey(S,X,Da,O,M,TL1,TL2,TL3,TA1,TA2,TA3),T3=TL3,TL1=T1,TL2>=T2,\+ Da=O,route(X,D,O,TA1,TA2,TA3,L1,L2),count(S,L2,0,Y),\+ Y>=3,
							 count(X,L2,0,Z),\+ Z>=3,addelem([M,Da,TL1,TL2,TL3,S,O,TA1,TA2,TA3,X],L2,L).
